...
public class StudentController {
    ...
    public Map<String, Object> upload(@RequestParam("file") MultipartFile file,@RequestParam("stuNo") String stuNo,@RequestParam("teaNo") String teaNo
                                      ) throws IOException {
...
//        }
        ...
        int tea_no = Integer.parseInt(teaNo);
//        int tea_no = teaNo;
